...
> = {
  fusion: {
    label: 'Fusion',
    description: 'Blood Orange — Neon Yellow & Crimson',
    accent: '#EE2200',
    surface: '#141E41',
    text: '#F8FAFC',
    badge: 'Dark',
  ...
  cyber: {
    label: 'Cyber',
    description: 'Arctic Blue — Neon Gold & Ruby',
    accent: '#38BDF8',
    surface: '#0C1830',
    text: '#E0F2FE',
    badge: 'Dark',
  ...
  executive: {
    label: 'Executive',
    description: 'Corporate White — Navy & Power Red',
    accent: '#1E3A8A',
    surface: '#FFFFFF',
    text: '#0F172A',
    badge: 'Light',
  ...
  heritage: {
    label: 'Heritage',
    description: 'Gallery White — Vinotinto & Moss',
    accent: '#991B1B',
    surface: '#FFFFFF',
    text: '#1C1917',
    badge: 'Light',
